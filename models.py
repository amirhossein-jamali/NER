from networks import NERNetwork
...
class NER:
    ...
    A NER model object containing a complete model configuration.
    ...
    def __init__(self,
        ...
        Args:
            ...
            dataset_training (dict, optional): the training data. Must consist
                ...
                look like by invoking functions get_dane_data() or get_data().
            ...
            network (torch.nn.module, optional): network to be trained. Defaults
                to a default generic `NERNetwork`. Can be replaced with your own
                customized network architecture. It must however take the same
                arguments as `NERNetwork`.
        ...
        self.network = NERNetwork(self.transformer_model, self.device, len(tag_complete), dropout=dropout)
    ...
    def load_network_from_file(self, model_path="model.bin") -> str:
        """Load Pretrained NER Network from file

        Loads weights for a pretrained NER Network from file.
